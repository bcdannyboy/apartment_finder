...
| CONSTRAINT_RETRIEVAL_LOCAL_ONLY | architecture_retrieval.md | phase_tests_phase6.md |
...
| CONSTRAINT_NETWORK_EGRESS_ALLOWLIST | architecture_compliance_enforcement.md | phase_tests_integration.md |
